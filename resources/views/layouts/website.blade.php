                ...
                <div class="container-fluid menu-area">
                    ...
                    <div class="tools pe-3">
                        ...
                        <div class="btn-group">
                            ...
                            <a href="#" class="btn border border-light-subtle"> <i class="fa-solid fa-newspaper"></i> ই-পেপার
                            </a>
                        </div>
                        <div class="search-box">
                            <form class="d-flex">
...
<footer id="footer_area">
    ...
    <div class="text_area wrapper">
        <p>Message Today is the Digital news media outlet in Bangladesh.across online and multimedia sectors. We are committed to publishing the real news
        </p>
    </div>
    ...
    <div class="col-sm-7">
        <p class="small text-muted">
            <span>Editor (in charge): Sristy Talukdar<br>© 2025 All Rights Reserved | TheMessage2Day.com,
    ...
    <div class="col-sm-5 footer-top hidden-print">
        <ul class="footer-menu text-end">
            <li class="d-inline me-2"><a class="border border-secondary p-2" href="#">About Us</a></li>
            <li class="d-inline me-2"><a class="border border-secondary p-2" href="#">Contact</a></li>
            <li class="d-inline me-2"><a class="border border-secondary p-2" href="#" target="_blank">Privacy Policy</a></li>
        </ul>
    </div>
</div>
