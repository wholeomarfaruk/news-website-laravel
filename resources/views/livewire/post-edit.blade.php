        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                @if ($post->status === 'published')
                                                    ...
                                                    @endif
            <button type="submit" wire:click="$set('status', 'draft')" class="inline-flex items-center gap-2 rounded-lg bg-white px-4 py-3 text-sm font-medium text-gray-700 shadow-theme-xs ring-1 ring-gray-300 transition hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-400 dark:ring-gray-700 dark:hover:bg-white/[0.03]">
                Draft
            </button>
            <button type="submit" wire:click="$set('status', 'published')" class="inline-flex items-center gap-2 rounded-lg bg-white px-4 py-3 text-sm font-medium text-gray-700 shadow-theme-xs ring-1 ring-gray-300 transition hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-400 dark:ring-gray-700 dark:hover:bg-white/[0.03]">
                Publish
            </button>
            </div>
        </div>
        ...
        <div class="border-t border-gray-100 mt-4  dark:border-gray-800">
            ...
            <div class="flex h-full flex-col gap-6 sm:gap-5 xl:flex-row">
                ...
                <div
                    ...
                    <div x-data="{ switcherToggle: @entangle('isFeatured') }">
                        ...
                        <label for="toggle1"
                            ...
                            <div class="relative">
                                <input x-model="switcherToggle"  type="checkbox" id="toggle1" class="sr-only">
                                <div
        ...
        <div @click.away="open = false"
            ...
            <div class="mt-4 flex justify-end gap-2">
                ...
                <button wire:click="createCategory"
                    ...
                    @livewire('post-create-featured-image')
                </div>
